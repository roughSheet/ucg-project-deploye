...
import logo from '../assets/logo.png'   // same logo import
    ...
    <footer style={{ background: '#0b1c2c', color: 'rgba(255,255,255,0.68)' }}>
      ...
      <div className="container" style={{ paddingTop: 52, paddingBottom: 44 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 44, marginBottom: 44 }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: 1 }}>BPO Solutions</div>
              </div>
            </div>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, background: 'rgba(29,111,184,0.2)', border: '1px solid rgba(29,111,184,0.4)', borderRadius: 8, padding: '7px 13px' }}>
              <span style={{ color: '#60a5fa', fontSize: 13 }}>🏅</span>
              <span style={{ color: '#60a5fa', fontSize: 12, fontWeight: 600 }}>ISO 27001:2013 Certified</span>
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <div style={{ color: 'white', fontWeight: 700, marginBottom: 16, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1, borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 10 }}>Quick Links</div>
            {[['/', 'Home'], ['/about', 'About Us'], ['/blogs', 'Blog'], ['/contact', 'Contact']].map(([p, l]) => (
              <Link key={p} to={p} style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 11, fontSize: 13, color: 'rgba(255,255,255,0.6)', transition: 'color 0.2s' }}
                ...
                <span style={{ color: '#1d6fb8', fontSize: 9 }}>▶</span>{l}
              </Link>
            ))}
          </div>
          ...
          {/* Services */}
          <div>
            <div style={{ color: 'white', fontWeight: 700, marginBottom: 16, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1, borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 10 }}>Services</div>
            {[
          ...
          {/* Contact */}
          <div>
            <div style={{ color: 'white', fontWeight: 700, marginBottom: 16, fontSize: 13, textTransform: 'uppercase', letterSpacing: 1, borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 10 }}>Contact</div>
            {[
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 22, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 }}>
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.38)' }}>© 2026 U-Connect Global Services. All Rights Reserved.</div>
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.38)' }}>Trusted BPO Partner · HIPAA Compliant · ISO 27001:2013</div>
        </div>
      </div>
    </footer>
  )
